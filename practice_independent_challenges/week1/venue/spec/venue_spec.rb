...
describe Venue do
  ...
  describe '#over_capacity' do
    it 'will return  false if the venue does not have more patrons than the capacity' do
      venue = Venue.new('Bluebird', 4)
    ...
    it 'will return true if the venue has more patrons than the capacity' do
      venue = Venue.new('Bluebird', 4)
  ...
  describe '#kick_out' do
    it 'method will continue to remove patrons from the venue until it is no longer over capacity' do
      venue = Venue.new('Bluebird', 4)
